...
<div style="display: flex; gap: 24px; margin-bottom: 24px; flex-wrap: wrap;">
  ...
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <iframe
      width="100%"
      height="180"
      src="https://www.youtube.com/embed/1k3aUUkMxvg"
      frameborder="0"
  ...
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <iframe
      width="100%"
      height="180"
      src="https://www.youtube.com/embed/57oUQLf85TI"
      frameborder="0"
      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
      allowfullscreen>
    </iframe>
    <p style="margin-top: 8px; font-size: 0.95rem;">
      <strong>Session 2:</strong> How AI/ML and Rational Drug Design are Transforming Drug Discovery.
    </p>
  </div>
  ...
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <iframe
      width="100%"
      height="180"
      src="https://www.youtube.com/embed/y-WX6gcXlOI"
      frameborder="0"
      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
      allowfullscreen>
    </iframe>
    <p style="margin-top: 8px; font-size: 0.95rem;">
      <strong>Session 3:</strong> Fundamentals of Generative AI and Ultra-Large Chemical Space Docking.
    </p>
  </div>
</div>
...
<div style="display: flex; align-items: center; gap: 20px; margin-bottom: 20px;">
  <iframe
    width="250"
    height="200"
    src="https://www.youtube.com/embed/videoseries?list=PLtKHReMoCMwnXJCsnICAYXDIK0yGmeNSF"
    frameborder="0"
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
    allowfullscreen>
  </iframe>
  <div>
    <h5 style="
      ...
      color: #000000;">
      Overview of the workshop objectives and structure. Key concepts, tools, and workflows covered in the sessions.
    </h5>
  </div>
</div>
