...
<div style="display: flex; gap: 24px; margin-bottom: 24px; flex-wrap: wrap;">
  ...
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <iframe
      width="100%"
      height="180"
      src="https://www.youtube.com/embed/kWvyBPK4eqo"
      frameborder="0"
      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
      allowfullscreen>
    </iframe>
  ...
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <iframe
      width="100%"
      height="180"
      src="https://www.youtube.com/embed/iM5aKy138Co"
      frameborder="0"
      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
      allowfullscreen>
    </iframe>
    <p style="margin-top: 8px; font-size: 0.95rem;">
      <strong>Session 3:</strong> Discussion on research assessment framework.
    </p>
  </div>
