...
<div style="display: flex; gap: 24px; margin-bottom: 24px; flex-wrap: wrap;">
  ...
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <a href="https://www.youtube.com/watch?v=2-ylszYZ5V4" target="_blank" style="position: relative; display: block;">
      <img src="https://img.youtube.com/vi/2-ylszYZ5V4/hqdefault.jpg"
           alt="Inaugural address"
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>Inaugural Address by Dr. Gitanjali Yadav:</strong> Introduction to the CODATA India Hands-on Workshop on “Liberation, Extraction & FAIR Reuse of Data”.
    </p>
  </div>

  <!-- Session info -->
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <a href="https://www.youtube.com/watch?v=EyS7PyzMDS8" target="_blank" style="position: relative; display: block;">
      <img src="https://img.youtube.com/vi/EyS7PyzMDS8/hqdefault.jpg"
           alt="Welcome address"
           style="width: 100%; height: auto; border-radius: 6px;">
      <span style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%);
                   background:rgba(0,0,0,0.6); border-radius:50%;
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>Welcome Address by Dr. D. Chattopadhyay, Director BRIC-NIPGR:</strong> Highlighting the importance of transforming scientific publications and biodiversity data into structured, reusable knowledge.
    </p>
  </div>
  ...
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>The Plazi workflow by Dr. Felipe Simoes, PLAZI:</strong> Access and reuse of biodiversity data.
    </p>
  </div>

  <!-- Session info -->
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <a href="https://www.youtube.com/watch?v=LjPgTlplvJw" target="_blank" style="position: relative; display: block;">
      <img src="https://img.youtube.com/vi/LjPgTlplvJw/hqdefault.jpg"
           alt="day 2 session 2"
           style="width: 100%; height: auto; border-radius: 6px;">
      <span style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%);
                   background:rgba(0,0,0,0.6); border-radius:50%;
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>Prof. Manzoor Shah, Univ of Kashmir, Srinagar:</strong> Long Term Bioidiversity Informatics Research.
    </p>
  </div>

  <!-- Session info -->
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <a href="https://www.youtube.com/watch?v=2zr_5iJzG7Y" target="_blank" style="position: relative; display: block;">
      <img src="https://img.youtube.com/vi/2zr_5iJzG7Y/hqdefault.jpg"
           alt="day 1 session 2"
           style="width: 100%; height: auto; border-radius: 6px;">
      <span style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%);
                   background:rgba(0,0,0,0.6); border-radius:50%;
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>Dr. Renu Kumari, Semantic Climate:</strong> The #semanticCimate Toolkit for Knowledge Extraction from Literature.
    </p>
  </div>

  <!-- Session info -->
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <a href="https://www.youtube.com/watch?v=ky1Ow06_acM" target="_blank" style="position: relative; display: block;">
      <img src="https://img.youtube.com/vi/ky1Ow06_acM/hqdefault.jpg"
           alt="day 1 session 3"
           style="width: 100%; height: auto; border-radius: 6px;">
      <span style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%);
                   background:rgba(0,0,0,0.6); border-radius:50%;
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>Ms. Priti, BRIC-NIPGR:</strong> Hands-on demonstration of the semantic toolkit using a Colab notebook.
    </p>
  </div>

  <!-- Session info -->
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <a href="https://www.youtube.com/watch?v=Ezz7ObSZnxM" target="_blank" style="position: relative; display: block;">
      <img src="https://img.youtube.com/vi/Ezz7ObSZnxM/hqdefault.jpg"
           alt="day 2 session 1"
           style="width: 100%; height: auto; border-radius: 6px;">
      <span style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%);
                   background:rgba(0,0,0,0.6); border-radius:50%;
  ...
  <!-- Session info -->
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <a href="https://www.youtube.com/watch?v=6Jt8_fTCnEA" target="_blank" style="position: relative; display: block;">
      <img src="https://img.youtube.com/vi/6Jt8_fTCnEA/hqdefault.jpg"
           alt="day 3 session 1"
           style="width: 100%; height: auto; border-radius: 6px;">
      <span style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%);
                   background:rgba(0,0,0,0.6); border-radius:50%;
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>Dr. Felipe Simoes, PLAZI:</strong> Manual vs automated workflows for conversion, annotation, and retrieval.
    </p>
  </div>

  <!-- Session info -->
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <a href="https://www.youtube.com/watch?v=RUwWZmkTnMc" target="_blank" style="position: relative; display: block;">
      <img src="https://img.youtube.com/vi/RUwWZmkTnMc/hqdefault.jpg"
           alt="day 3 session 2"
           style="width: 100%; height: auto; border-radius: 6px;">
      <span style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%);
                   background:rgba(0,0,0,0.6); border-radius:50%;
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>Dr. Julia Giora, PLAZI:</strong> Materials citation, annotation, quality control and data validation.
    </p>
  </div>

  <!-- Session info -->
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <a href="https://www.youtube.com/watch?v=AU3ZaFLoYYU" target="_blank" style="position: relative; display: block;">
      <img src="https://img.youtube.com/vi/AU3ZaFLoYYU/hqdefault.jpg"
           alt="day 3 session 3"
           style="width: 100%; height: auto; border-radius: 6px;">
      <span style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%);
                   background:rgba(0,0,0,0.6); border-radius:50%;
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>Panel Discussion on</strong> “Biodiversity Informatics Education in India”.
    </p>
  </div>

  <!-- Session info -->
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <a href="https://www.youtube.com/watch?v=y3AiXXlBIJ8" target="_blank" style="position: relative; display: block;">
      <img src="https://img.youtube.com/vi/y3AiXXlBIJ8/hqdefault.jpg"
           alt="day 3 session 4"
           style="width: 100%; height: auto; border-radius: 6px;">
      <span style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%);
                   background:rgba(0,0,0,0.6); border-radius:50%;
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>Dr. Felipe Simoes, PLAZI:</strong> “Hands-on, Accessing data from Global Biodiversity repositories”.
    </p>
  </div>
...
<div style="display: flex; gap: 24px; margin-bottom: 24px; flex-wrap: wrap;">
  ...
  <!-- Session info -->
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <a href="https://www.youtube.com/watch?v=N1b0BGnG8_o" target="_blank" style="position: relative; display: block;">
      <img src="https://img.youtube.com/vi/N1b0BGnG8_o/hqdefault.jpg"
           alt="Team 4 presentation"
           style="width: 100%; height: auto; border-radius: 6px;">
      <span style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%);
                   background:rgba(0,0,0,0.6); border-radius:50%;
                   width:48px; height:48px; display:flex;
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>Team name - Gurukul Genes,</strong> Title of the presentation: "The Broad Spectrum Anticancer Potential of Catharanthus roseus".
    </p>
  </div>

  <!-- Session info -->
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <a href="https://www.youtube.com/watch?v=N2-lPXEMKZM" target="_blank" style="position: relative; display: block;">
      <img src="https://img.youtube.com/vi/N2-lPXEMKZM/hqdefault.jpg"
           alt="Team 5 presentation"
           style="width: 100%; height: auto; border-radius: 6px;">
      <span style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%);
                   background:rgba(0,0,0,0.6); border-radius:50%;
                   width:48px; height:48px; display:flex;
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>Team name - Milling Millets,</strong> Title of the presentation: "Milling Millets".
    </p>
  </div>

  <!-- Session info -->
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <a href="https://www.youtube.com/watch?v=Vtz0w1blYCU" target="_blank" style="position: relative; display: block;">
      <img src="https://img.youtube.com/vi/Vtz0w1blYCU/hqdefault.jpg"
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>Team name - Night Shade,</strong> Title of the presentation: "An integrated approach to in-silico phylogenetic analysis of Solanaceae using modern data tools".
    </p>
  </div>

  <!-- Session info -->
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <a href="https://www.youtube.com/watch?v=B3ZlWVIuBXY" target="_blank" style="position: relative; display: block;">
      <img src="https://img.youtube.com/vi/B3ZlWVIuBXY/hqdefault.jpg"
           alt="Team presentation"
           style="width: 100%; height: auto; border-radius: 6px;">
      <span style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%);
                   background:rgba(0,0,0,0.6); border-radius:50%;
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>Team name - Phylomorph,</strong> Title of the presentation: "FAIR Reuse of Biodiversity Data using PLAZI platform".
    </p>
  </div>
...
<div style="display: flex; gap: 24px; margin-bottom: 24px; flex-wrap: wrap;">
  ...
  <!-- Session 2 -->
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    <a href="https://www.youtube.com/watch?v=y-WX6gcXlOI" target="_blank" style="position: relative; display: block;">
      <img src="https://img.youtube.com/vi/y-WX6gcXlOI/hqdefault.jpg"
           alt="Session 2 video"
           style="width: 100%; height: auto; border-radius: 6px;">
      <span style="position:absolute; top:50%; left:50%; transform:translate(-50%,-50%);
                   background:rgba(0,0,0,0.6); border-radius:50%;
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>Session 2:</strong> Fundamentals of Generative AI and Ultra-Large Chemical Space Docking.
    </p>
  </div>
  ...
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>Session 3a:</strong> How Do We Assess This Work? Beyond Publications and Impact Factors.
    </p>
  </div>
  ...
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>Session 3b:</strong> Discussion on research assessment framework.
    </p>
  </div>
...
<div style="display: flex; gap: 24px; margin-bottom: 24px; flex-wrap: wrap;">
  ...
  <div style="flex: 1; min-width: 240px; max-width: 300px;">
    ...
    <p style="margin-top:8px; font-size:0.95rem;">
      <strong>Inaugural Session:</strong> Research AI Summit 2025 at NIPGR, New Delhi.
    </p>
  </div>
