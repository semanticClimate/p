...
**Currently accepted abstract**

## Abstract 1

#### Title

From Data to Action: Prioritizing Climate Adaptation Strategies for Vulnerable Communities
...
Leveraging text mining for better policy making: exploring the correlation of precipitation change with agriculture
...
*manishagoel@south.du.ac.in (Corresponding Author).
...
Synthetic biology and mitigation strategies for harmful algal blooms
...
ACKSE: A Computable Knowledge form of Species Extinction due to Climate Change 
...
Guiding Principles in Measuring Data Reusability
...
Utilizing Geospatial Data for Monitoring and Managing Invasive Species: A Contribution to Sustainable Development
...
Power and Inequality in Global Knowledge Production
...
Science as a public good: the role of community and technology for equity, sustainability and development in the Global South

#### Authors

Arianna Becerril García 
abecerrilg@uaemex.mx
...
A Study of Research Data Policy of Highly Ranked Journals Contributing to Sustainable Development Goals 

#### Authors

Prof. Dinesh K. Guptaa, Sushree Snigdha Dandpata, Kavya Asoka and Sapna Devia
aDepartment of Library and Information Science, Central University of Haryana, Mahendergarh
dineshkg@cuh.ac.in
snigdhadandpat97@gmail.com
kavyadvg4@gmail.com
sapnabadgal@gmail.com
...
Why are libraries still violating procurement rules?
or
Libraries should also follow procurement rules
...
AMI - a pipeline to make and re-use semantic corpora

#### Authors

semantic climate team
