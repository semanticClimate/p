...
![toolkits]({{ '/static/img/events_all/semantic_graph.png' | url }})
...
![resources]({{ '/static/img/events_all/semantic_graph1.png' | url }})
...
![workflow]({{ '/static/img/events_all/corpus_workflow.png' | url }})
...
![workflow]({{ '/static/img/events_all/dict_sC.png' | url }})
